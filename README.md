...
Deployed Application (**required**): https://kudos-board-3.onrender.com/
...
The topics discussed in the labs did prepare me to complete the assignment-- specifcially in regards to the backend setup. Lab 2 and lab 3 were incredibly helpful when it came to setting up and running CRUD operations and lab 4 helped me connect my frontend to the backend. I would have liked a bit more guidance on connecting the frontend to the background for other requests other than GET and I felt unprepared for the dark/light mode, however, after some CSS research, this was manageable.

- If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.

I would have used useContext() instead of individually assigning props, especially for features that required numerous props where it was getting harder to organize. Additionally, I with more time, I would have liked to examine places where I could combine components (instead of making individual components for every new element I created) in order to make my components more organized and prevent repetitive code.

- Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

While the functionality remained the same across the demos, I do feel that I could have improved my UI to something that is more adapatable to whether or not optional elements are present-- for exmaple, in my comments pop-up, if there are no comments present, it is a bit long as if it is anticipating comments, which isn't preferable from a UI perspective. Additionally, I really struggled to keep the footer at the bottom of the page when there were no cards or boards present, something I would like to improve on for future reference.
